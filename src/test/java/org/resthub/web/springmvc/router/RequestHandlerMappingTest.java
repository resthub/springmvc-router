...
public class RequestHandlerMappingTest {
    ...
    /**
     * Test route with HTTP method overriding (HEAD -> GET): GET /simpleaction
     * myTestController.simpleAction
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test route: GET /param myTestController.paramAction(param:'default')
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("param"), "default");
    ...
    /**
     * Test route: GET /param/{param} myTestController.paramAction
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("param"), "myparam");
    ...
    /**
     * Test route: GET /http myTestController.httpAction(type:'GET')
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("type"), "GET");
    ...
    /**
     * Test route: PUT /http myTestController.httpAction(type:'PUT')
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("type"), "PUT");
    ...
    /**
     * Test route: POST /http myTestController.httpAction(type:'POST')
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("type"), "POST");
    ...
    /**
     * Test route: DELETE /http myTestController.httpAction(type:'DELETE')
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("type"), "DELETE");
    ...
    /**
     * Test route: PUT /http myTestController.httpAction(type:'PUT') with a GET
     * request and a "x-http-method-override" header
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("type"), "PUT");
    ...
    /**
     * Test route: PUT /http myTestController.httpAction(type:'PUT') with a GET
     * request and a "x-http-method-override" argument in queryString
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("type"), "PUT");
    ...
    /**
     * Test route: GET /regex/{<[0-9]+>number}
     * myTestController.regexNumberAction
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("number"), "42");
    ...
    /**
     * Test route: GET /regex/{<[a-z]+>string}
     * myTestController.regexStringAction
     *
     * @throws Exception
     */
    @Test
...
//        Assert.assertEquals(req.routeArgs.get("string"), "marvin");
    ...
    /**
     * Test route: GET /host myTestController.hostAction
     *
     * @throws Exception
     */
    @Test
